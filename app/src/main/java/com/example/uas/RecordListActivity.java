...
public class RecordListActivity extends AppCompatActivity {
    ...
    private void showDialogUpdate(RecordListActivity activity, final int position){
        final Dialog dialog = new Dialog(activity);
        dialog.setContentView(R.layout.update_dialog);
        dialog.setTitle("Update");

        imageViewIcon = dialog.findViewById(R.id.imageViewRecord);
        final EditText edtName = dialog.findViewById(R.id.edtClass);
        final EditText edtAge = dialog.findViewById(R.id.edtDay);
        final EditText edtPhone = dialog.findViewById(R.id.edtHour);
