...
public class MainActivity extends AppCompatActivity {
    ...
    EditText mEdtClass, mEdtDay, mEdtHour;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEdtHour = findViewById(R.id.edtHour);
            ...
            public void onClick(View view) {
                try {
                    mSQLiteHelper.insertData(
                            mEdtClass.getText().toString().trim(),
                            mEdtDay.getText().toString().trim(),
                            mEdtHour.getText().toString().trim(),
