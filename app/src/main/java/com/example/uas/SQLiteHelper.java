...
public class SQLiteHelper extends SQLiteOpenHelper{
    ...
    //insertData
    public void insertData(String name, String day, String hour, byte[] image){
        SQLiteDatabase database = getWritableDatabase();
    ...
    //updateData
    public void updateData(String name, String day, String hour, byte[] image, int id){
        SQLiteDatabase database = getWritableDatabase();
        //query to update record
        String sql = "UPDATE RECORD SET name=?, day=?, hour=?, image=? WHERE id=?";
